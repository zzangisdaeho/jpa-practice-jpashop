...
import static jpabook.jpashop.entity.QOrder.*;
...
public class OrderRepository {
    ...
    public List<Order> findAllWithMemberDelivery() {
        return em.createQuery("select o from orders o join fetch o.member m join fetch o.delivery d", Order.class).getResultList();
    }
    ...
    public List<Order> findAllWithMemberDelivery(int offset, int limit) {
        return em.createQuery("select o from orders o join fetch o.member m join fetch o.delivery d", Order.class)
